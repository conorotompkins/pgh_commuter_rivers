---
title: "Why does a Pittsburgher cross the river?"
...
ggraph(manual_layout) +
  ...
  scale_edge_alpha_continuous(range = c(.01, .5)) +
  labs(x = NULL,
       y = NULL,
...
It is always reasurring when your analysis doesn't stray to far from conventional wisdom. Very few Pittsburghers in the dataset cross two rivers to get to work, and none cross three.
