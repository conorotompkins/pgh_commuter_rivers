...
![faceted graph](images/faceted_graph.png)

## Data munging and analysis

I use the "pa_od_aux_JT00_2017.csv" file as shown here: ![LODES screenshot](images/lodes_screenshot.png)
...
plot_bar <- df_commuter_rivers_summary %>% 
  ...
  ggplot(aes(rivers_crossed, commuters)) +
    ...
    geom_text(aes(y = commuters + 8000, label = scales::comma(commuters))) +
...
ggsave(plot = plot_bar, filename = "output/high_resolution_bar_chart.png", device = "png",
...
faceted_map_plot <- df_chloro_map %>% 
  ...
  ggplot() +
    ...
    labs(title = "Commuter travel patterns",
         ...
         caption = "@conor_tompkins") +
    theme_void()
ggsave(plot = faceted_map_plot, filename = "output/high_resolution_facet_map.png", device = "png",
